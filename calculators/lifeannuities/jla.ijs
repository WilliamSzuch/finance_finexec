NB. =========================================================
NB.%jla.ijs - Joint life annuity calculator
NB.-<hr>
...
NB.-<hr>
NB.- Script: ~addons/finance/finexec/calculators/lifeannuities/jla.ijs
NB.- Contributor: William Szuch
NB.- Updated: 13/4/2021
NB.- Depend: ~addons/finance/finexec/qxtables/alt.ijs
NB.- Definitions: loaded to locale jla
NB.- Status: dev:
NB.- <a href="../lifeannuities/jla.ijs" target="_blank">Script source: jla.ijs</a>
NB.-<hr>
NB.- Joint life annuity  calculator
NB.-<pre>
NB.-Load and run:
NB.-load '~addons/finance/finexec/calculators/lifeannuities/jla.ijs'
NB.-Once loaded run: jla '' 
NB.-</pre>
NB.-<hr>
NB.- Equations:
NB.-<hr>
...
NB. =========================================================
NOTE_A=: 0 : 0
The value of the joint life annuity is based on the:
...
Qx1 =: ALT_2004_06_F
Qx2 =: ALT_2004_06_M
Vx =: ": 0.01 round (Qx1;Qx2;N_Eff)axy(N_Age1;N_Age2)
