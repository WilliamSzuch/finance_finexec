...
NB.-<hr>
NB.- Definition for grouping dates into periods  
...
NB.+D = dates to be grouped into periods
NB.+    date format: yyyymmdd 
NB.-example:
NB.+   (20190630 20200630)index_period(20190531 20190630 20190701)
NB.+0 0 1
NB.-
...
NB.- <b>Note:</b>
NB.- Leap year start date 29/2 not valid as invalid dates result.  
NB.-syntax:
NB.+(D)periods_yr(N)
